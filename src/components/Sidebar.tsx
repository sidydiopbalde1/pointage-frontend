      ...
      >
        ...
        <div className="flex items-center gap-3 px-5 py-5 border-b border-slate-700/50">
          ...
          <div>
            ...
            <p className="text-slate-400 text-xs">Gestion des présences</p>
          </div>
          <button
            onClick={onClose}
          ...
          {visibleItems.map((item, i) => {
            ...
            return (
              <Link
                ...
                href={item.href}
                onClick={onClose}
                className={`sidebar-link animate-slide-in-left animate-delay-${(i + 1) * 100} ${active ? 'active' : ''}`}
              >
                {item.icon}
        ...
        <div className="border-t border-slate-700/50 px-3 py-4">
          <div className="flex items-center gap-3 px-2 mb-3">
            <div className="w-8 h-8 rounded-full bg-gradient-to-br from-indigo-400 to-violet-500 flex items-center justify-center text-white font-semibold text-sm shrink-0">
